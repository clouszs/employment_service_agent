...
<template>
  <div>
    ...
    <el-table v-loading="loading" :data="rows" stripe border>
      ...
      <el-table-column label="操作" width="380" fixed="right">
        <template #default="{ row }">
          ...
          <el-button link type="danger" size="small" @click="hardDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="pager">
    ...
    <!-- 新建/编辑 -->
    <el-dialog v-model="dialogVisible" :title="editing ? '编辑学生' : '新建学生'" width="460px">
    ...
    <el-dialog v-model="pwdDialog" title="重置密码" width="380px">
      <div class="reset-tip">为学生「{{ pwdTarget?.real_name || pwdTarget?.username }}」设置新密码</div>
      <el-input
        v-model="newPwd"
        type="password"
        show-password
